      ...
      diagrams: [
        {
          kind: "source",
          beforePart: "A3",
          src: "/exam-assets/ee306/ece306-e2-instruction-datapath.png",
          width: 1695,
          height: 1776,
          title: "Instruction format and modified datapath",
          alt: "Exact source diagram of opcode 1101 with fields SR1, SR2, and PCoffset6 and the modified LC-3 datapath, where TEMP and the SEL1 and SEL2 multiplexers are shown in bold.",
          description: "Exact crop from the public source exam; bold paths identify the added hardware.",
        },
        {
          kind: "source",
          beforePart: "A8",
          src: "/exam-assets/ee306/ece306-e2-microsequencer-control.png",
          width: 1794,
          height: 1920,
          title: "Modified microsequencer and incomplete control store",
          alt: "Exact source diagram of the modified LC-3 microsequencer with Z and the AND-plus-mux J5 path, alongside a five-row control-store table whose second and third state-number cells are blank.",
          description: "Exact crop from the public source exam, including every logic connection and control-store field.",
        },
        {
          kind: "source",
          beforePart: "A1",
