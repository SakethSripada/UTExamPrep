      ...
      diagrams: [
        {
          ...
          width: 1320,
          height: 620,
          title: "Player linked-list representation",
      ...
      diagrams: [
        {
          ...
          alt: "Opcode 1101 with fields SR1, SR2, and PCoffset6 and the modified LC-3 datapath, where TEMP and the SEL1 and SEL2 multiplexers are shown in bold.",
          description: "Bold paths identify the added hardware.",
        },
        {
          kind: "source",
          beforePart: "A8",
          ...
          alt: "Modified LC-3 microsequencer with Z and the AND-plus-mux J5 path, alongside a five-row control-store table whose second and third state-number cells are blank.",
        },
        {
          kind: "source",
          beforePart: "A1",
