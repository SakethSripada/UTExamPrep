      ...
      diagrams: [
        {
          ...
          description: "The vector redraw preserves the source D-pad layout and bit positions [3:0]. GC_SR is xFEA0 and GC_DR is xFEA2.",
        },
      ],
      ...
      diagrams: [
        {
          ...
          description: "The source changes are preserved as a hand-drawn focused datapath diagram: TEMP can capture SR1OUT, SEL2 chooses TEMP, ONE, or SR2OUT, and SEL1 chooses a zero path or SR1OUT.",
        },
        {
          kind: "source",
      ...
      solutionDiagrams: [
        {
          ...
          description: "Review-only reproduction of the official state-machine completion.",
        },
      ],
