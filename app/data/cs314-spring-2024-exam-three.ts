      ...
      diagrams: [
        {
          ...
          description:
            "The unknown value occupies the last node before removal and the left child of the root afterward.",
        ...
        },
        {
          ...
          description: "The table has array indices 0 through 4 and starts empty.",
        ...
        },
        {
          ...
          description: "Timing observations for the unknown graph algorithm, in seconds.",
...
System.out.print(Arrays.toString(result));`,
    ...
    },
    {
      ...
      diagrams: [
        {
          kind: "source",
          title: "Example BinTree",
          description: "The blue arrow denotes the tree root.",
      ...
      diagrams: [
        {
          ...
          description: "Dot edges go left and dash edges go right. Do not assume the implementation tree is exactly this reference, except that valid paths end at valid symbols.",
      ...
      diagrams: [
        {
          ...
          description: "Solid red edges mark the Hamiltonian path; unused edges are black and dotted.",
