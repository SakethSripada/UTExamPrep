...
class BinarySearchTree<E extends Comparable<E>> implements ExamSnapshot {
...
// __STUDENT_CODE__
    ...
    static BinarySearchTree<Integer> fixture() {
    ...
    public Object examCall(int caseIndex) {
        BinarySearchTree other = BinarySearchTree.fixture();
