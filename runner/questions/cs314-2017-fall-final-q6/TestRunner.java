...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            BitInputStream sBits = new BitInputStream(1, 1, 1, 0, 0, 1);
            BitInputStream oBits = new BitInputStream(1, 1, 1, 0, 0, 1);
            ...
            Outcome studentOutcome = Outcome.capture(() -> StudentSolution.bitsSaved(sBits));
            Outcome oracleOutcome = Outcome.capture(() -> OracleStudentSolution.bitsSaved(oBits));
