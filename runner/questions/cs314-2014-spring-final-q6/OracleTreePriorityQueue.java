...
class OracleTreePriorityQueue<E extends Comparable<E>> implements ExamSnapshot {
...
public E dequeue() {
    ...
    private OracleTreePriorityQueue() { }
    static OracleTreePriorityQueue<Integer> fixture() {
        OracleTreePriorityQueue<Integer> tree = new OracleTreePriorityQueue<>();
    ...
    public Object examCall(int caseIndex) {
        OracleTreePriorityQueue other = OracleTreePriorityQueue.fixture();
