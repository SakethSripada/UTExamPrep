...
class TreePriorityQueue<E extends Comparable<E>> implements ExamSnapshot {
...
// __STUDENT_CODE__
    ...
    private TreePriorityQueue() { }
    static TreePriorityQueue<Integer> fixture() {
        TreePriorityQueue<Integer> tree = new TreePriorityQueue<>();
    ...
    public Object examCall(int caseIndex) {
        TreePriorityQueue other = TreePriorityQueue.fixture();
