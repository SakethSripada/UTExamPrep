import java.util.*;
class OracleTrie implements ExamSnapshot {
...
private void getWords(TNode node, List<String> result, String word) {
    ...
    static OracleTrie fixture(){OracleTrie t=new OracleTrie();for(String w:new String[]{"bat","bats","bad","be","bear","bed","bee","been","bees","do","dog"})t.addWord(w);return t;}
