...
public class TestRunner {
    ...
    private static void runCases() {
        ...
        for (String[] fixture : fixtures) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> { student.insertAfterNth(target, "B", amount); return null; });
            Outcome oracleOutcome = Outcome.capture(() -> { oracle.insertAfterNth(target, "B", amount); return null; });
