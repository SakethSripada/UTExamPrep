...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> StudentSolution.sameBottomN(sStack, sStack, amount));
            Outcome oracleOutcome = Outcome.capture(() -> OracleStudentSolution.sameBottomN(oStack, oStack, amount));
