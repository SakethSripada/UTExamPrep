...
class SortedSet<E extends Comparable<E>> implements ExamSnapshot {
...
// __STUDENT_CODE__
    ...
    private SortedSet() { }
    static SortedSet<Integer> fixture() {
        SortedSet<Integer> list = new SortedSet<>();
    ...
    public Object examCall(int caseIndex) {
        SortedSet other = SortedSet.fixture();
