...
class OracleSortedSet<E extends Comparable<E>> implements ExamSnapshot {
    ...
    private static class Node<T> {
        ...
        T getData() { return value; } T getValue() { return value; }
...
public boolean add(E value) {
    ...
    private OracleSortedSet() { }
    static OracleSortedSet<Integer> fixture() {
        OracleSortedSet<Integer> list = new OracleSortedSet<>();
    ...
    public Object examCall(int caseIndex) {
        OracleSortedSet other = OracleSortedSet.fixture();
        
        Object result = add((E) Integer.valueOf(9));
