...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> StudentSolution.pathExists(target, "B", amount, sBuildingMap));
            Outcome oracleOutcome = Outcome.capture(() -> OracleStudentSolution.pathExists(target, "B", amount, oBuildingMap));
