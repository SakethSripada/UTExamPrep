...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> { StudentSolution.update(currentCase % 3, currentCase % 3); return null; });
            Outcome oracleOutcome = Outcome.capture(() -> { OracleStudentSolution.update(currentCase % 3, currentCase % 3); return null; });
