...
class BinTree<E extends Comparable<E>> implements ExamSnapshot {
...
// __STUDENT_CODE__
    ...
    static BinTree<Integer> fixture() {
        return fixtureForCase(0);
    }

    private static BinTree<Integer> fixtureForCase(int caseIndex) {
    ...
    public Object examCall(int caseIndex) {
        BinTree<Integer> tree = fixtureForCase(caseIndex);
