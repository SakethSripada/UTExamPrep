...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> student.getSteadyNames(namesArg, amount));
            Outcome oracleOutcome = Outcome.capture(() -> oracle.getSteadyNames(namesArg, amount));
