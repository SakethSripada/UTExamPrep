...
public class TestRunner {
    ...
    private static void runCases() {
        ...
        for (String[] fixture : fixtures) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> { student.removeFirstN(amount); return null; });
            Outcome oracleOutcome = Outcome.capture(() -> { oracle.removeFirstN(amount); return null; });
