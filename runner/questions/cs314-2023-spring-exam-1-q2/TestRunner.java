...
public class TestRunner {
    ...
    private static void runCases() {
        ...
        for (String[] fixture : fixtures) {
            GenericList<String> source = GenericList.of(fixture);
            OracleGenericList<String> oracleSource = OracleGenericList.of(fixture);
            int[] counts = new int[fixture.length];
            for (int i = 0; i < counts.length; i++) counts[i] = (i + caseIndex) % 3;
            GenericList<String> student = new GenericList<>(source, counts);
            OracleGenericList<String> oracle = new OracleGenericList<>(oracleSource, counts);
