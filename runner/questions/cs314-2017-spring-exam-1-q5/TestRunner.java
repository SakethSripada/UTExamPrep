...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> student.getSubstringNames(amount, amount));
            Outcome oracleOutcome = Outcome.capture(() -> oracle.getSubstringNames(amount, amount));
