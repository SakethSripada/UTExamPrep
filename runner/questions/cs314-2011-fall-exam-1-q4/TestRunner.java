...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> { student.newDecade(newRanks); return null; });
            Outcome oracleOutcome = Outcome.capture(() -> { oracle.newDecade(newRanks); return null; });
