...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            sMap2.put("A", 4); sMap2.put("B", -2); sMap2.put("D", 9); oMap2.putAll(sMap2);
            ...
            Outcome studentOutcome = Outcome.capture(() -> StudentSolution.dotProduct(sMap, sMap2));
            Outcome oracleOutcome = Outcome.capture(() -> OracleStudentSolution.dotProduct(oMap, oMap2));
