...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> { student.remove(sStack, null); return null; });
            Outcome oracleOutcome = Outcome.capture(() -> { oracle.remove(oStack, null); return null; });
