...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> student.examCall(amount, rectangles, sBoolMatrix, goalRectangle));
            Outcome oracleOutcome = Outcome.capture(() -> oracle.examCall(amount, rectangles, oBoolMatrix, goalRectangle));
