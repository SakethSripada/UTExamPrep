...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Map sMap = new LinkedHashMap() {{ put("A", new Point(0, 0)); put("B", new Point(1, 0)); put("C", new Point(10, 0)); }};
            ...
            Outcome studentOutcome = Outcome.capture(() -> { student.removePointsHalfAverageDistance(sMap, "B"); return null; });
            Outcome oracleOutcome = Outcome.capture(() -> { oracle.removePointsHalfAverageDistance(oMap, "B"); return null; });
