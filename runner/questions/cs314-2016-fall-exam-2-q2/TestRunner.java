...
public class TestRunner {
    ...
    private static void runCases() {
        ...
        for (String[] fixture : fixtures) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> { student.replaceSmaller(sOther); return null; });
            Outcome oracleOutcome = Outcome.capture(() -> { oracle.replaceSmaller(oOther); return null; });
