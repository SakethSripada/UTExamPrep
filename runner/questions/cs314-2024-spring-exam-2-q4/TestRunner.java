...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> student.examCall(startAirline, destinationAirline, sAirlines));
            Outcome oracleOutcome = Outcome.capture(() -> oracle.examCall(startAirline, destinationAirline, oAirlines));
