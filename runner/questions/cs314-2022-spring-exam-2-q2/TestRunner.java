...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> StudentSolution.getIndex(sGrid, sWords));
            Outcome oracleOutcome = Outcome.capture(() -> OracleStudentSolution.getIndex(oGrid, oWords));
