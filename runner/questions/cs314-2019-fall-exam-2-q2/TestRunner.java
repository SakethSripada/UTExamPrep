...
public class TestRunner {
    ...
    private static void runCases() {
        ...
        for (String[] fixture : fixtures) {
            ...
            LinkedList314<String> student = LinkedList314.of(fixture);
            OracleLinkedList314<String> oracle = OracleLinkedList314.of(fixture);
            LinkedList314<String> studentOther = LinkedList314.of(otherFixture);
            OracleLinkedList314<String> oracleOther = OracleLinkedList314.of(otherFixture);
            LinkedList314<String> sOther = studentOther;
            OracleLinkedList314<String> oOther = oracleOther;
            student.examConvergeWith(studentOther); oracle.examConvergeWith(oracleOther);
            ...
            Outcome studentOutcome = Outcome.capture(() -> student.listsConverge(sOther));
            Outcome oracleOutcome = Outcome.capture(() -> oracle.listsConverge(oOther));
