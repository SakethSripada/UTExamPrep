...
public class TestRunner {
    ...
    private static void runCases() {
        ...
        for (String[] fixture : fixtures) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> student.rangeIsEqual(sOther, start, stop));
            Outcome oracleOutcome = Outcome.capture(() -> oracle.rangeIsEqual(oOther, start, stop));
