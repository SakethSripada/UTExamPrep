...
class OracleArrayMap<K, V> implements ExamSnapshot {
...
public V remove(K key) {
    ...
    static OracleArrayMap<String, Integer> fixture() {
        OracleArrayMap<String, Integer> map = new OracleArrayMap<>();
