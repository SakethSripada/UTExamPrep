...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> { student.makeDescending(sStack); return null; });
            Outcome oracleOutcome = Outcome.capture(() -> { oracle.makeDescending(oStack); return null; });
