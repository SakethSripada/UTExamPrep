...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> StudentSolution.getNum(sMap, amount));
            Outcome oracleOutcome = Outcome.capture(() -> OracleStudentSolution.getNum(oMap, amount));
