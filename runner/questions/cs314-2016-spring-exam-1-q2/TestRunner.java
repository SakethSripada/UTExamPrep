...
public class TestRunner {
    ...
    private static void runCases() {
        ...
        for (String[] fixture : fixtures) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> student.getDualSublist(sOther, start, stop));
            Outcome oracleOutcome = Outcome.capture(() -> oracle.getDualSublist(oOther, start, stop));
