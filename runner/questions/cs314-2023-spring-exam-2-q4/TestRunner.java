...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> StudentSolution.minSteps(sMatrix, currentCase % 3, currentCase % 3));
            Outcome oracleOutcome = Outcome.capture(() -> OracleStudentSolution.minSteps(oMatrix, currentCase % 3, currentCase % 3));
