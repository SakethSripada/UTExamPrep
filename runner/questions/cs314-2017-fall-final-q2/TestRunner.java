...
public class TestRunner {
    ...
    private static void runCases() {
        ...
        for (String[] fixture : fixtures) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> student.insertAndRemove(target, "B", target));
            Outcome oracleOutcome = Outcome.capture(() -> oracle.insertAndRemove(target, "B", target));
