...
class LinkedList314<E extends Comparable<E>> implements ExamSnapshot {
...
// __STUDENT_CODE__
    ...
    @SafeVarargs
    static <T extends Comparable<T>> LinkedList314<T> of(T... items) {
        LinkedList314<T> list = new LinkedList314<>();
    ...
    public void examConvergeWith(LinkedList314<E> other) {
