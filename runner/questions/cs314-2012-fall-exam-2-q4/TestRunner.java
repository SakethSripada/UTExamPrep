...
public class TestRunner {
    ...
    private static void runCases() {
        ...
        for (String[] fixture : fixtures) {
            ...
            LinkedList<String> student = LinkedList.of(fixture);
            OracleLinkedList<String> oracle = OracleLinkedList.of(fixture);
            LinkedList<String> studentOther = LinkedList.of(otherFixture);
            OracleLinkedList<String> oracleOther = OracleLinkedList.of(otherFixture);
            LinkedList<String> sOther = studentOther;
            OracleLinkedList<String> oOther = oracleOther;
            ...
            Outcome studentOutcome = Outcome.capture(() -> { student.removeRepeats(); return null; });
            Outcome oracleOutcome = Outcome.capture(() -> { oracle.removeRepeats(); return null; });
