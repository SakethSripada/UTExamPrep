...
public class TestRunner {
    ...
    private static void runCases() {
        ...
        for (String[] fixture : fixtures) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> { student.interleave(sOther); return null; });
            Outcome oracleOutcome = Outcome.capture(() -> { oracle.interleave(oOther); return null; });
