...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> { student.removeConsecutiveDuplicates(sQueue); return null; });
            Outcome oracleOutcome = Outcome.capture(() -> { oracle.removeConsecutiveDuplicates(oQueue); return null; });
