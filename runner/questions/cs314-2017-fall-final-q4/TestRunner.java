...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Map sMap = new LinkedHashMap() {{ put(123, new int[]{1,457,755,900}); put(222, new int[]{1}); put(335, new int[]{2}); put(457, new int[]{1,335,900}); put(755, new int[]{3,222}); put(900, new int[]{4}); }};
            Map oMap = new LinkedHashMap() {{ put(123, new int[]{1,457,755,900}); put(222, new int[]{1}); put(335, new int[]{2}); put(457, new int[]{1,335,900}); put(755, new int[]{3,222}); put(900, new int[]{4}); }};
            ...
            int amount = new int[]{755, 800, -335, -222, -123, -999}[caseIndex];
            int start = caseIndex % 2;
            int stop = Math.max(start, Math.min(base.length, start + amount));
            Outcome studentOutcome = Outcome.capture(() -> { student.updateRefCount(amount, sMap2); return null; });
            Outcome oracleOutcome = Outcome.capture(() -> { oracle.updateRefCount(amount, oMap2); return null; });
