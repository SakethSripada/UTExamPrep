...
public class TestRunner {
    ...
    private static void runCases() {
        ...
        for (String[] fixture : fixtures) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> { student.removeBetween(target); return null; });
            Outcome oracleOutcome = Outcome.capture(() -> { oracle.removeBetween(target); return null; });
