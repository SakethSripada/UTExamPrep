...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> StudentSolution.knightCanReach(currentCase % 3, targetPosition, startPosition, amount));
            Outcome oracleOutcome = Outcome.capture(() -> OracleStudentSolution.knightCanReach(currentCase % 3, targetPosition, startPosition, amount));
