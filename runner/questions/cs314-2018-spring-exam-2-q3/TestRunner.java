...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> StudentSolution.isStrictlyDecreasing(sQueue));
            Outcome oracleOutcome = Outcome.capture(() -> OracleStudentSolution.isStrictlyDecreasing(oQueue));
