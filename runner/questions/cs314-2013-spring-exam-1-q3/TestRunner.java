...
public class TestRunner {
    ...
    private static void runCases() {
        ...
        for (int[][] fixture : fixtures) {
            ...
            MathMatrix student = MathMatrix.of(fixture);
            OracleMathMatrix oracle = OracleMathMatrix.of(fixture);
            MathMatrix studentOther = MathMatrix.of(otherFixture);
            OracleMathMatrix oracleOther = OracleMathMatrix.of(otherFixture);
            MathMatrix sOther = studentOther;
            OracleMathMatrix oOther = oracleOther;
            ...
            Outcome studentOutcome = Outcome.capture(() -> { student.multiplyByVector(vectorArg); return null; });
            Outcome oracleOutcome = Outcome.capture(() -> { oracle.multiplyByVector(vectorArg); return null; });
