...
public class TestRunner {
    ...
    private static void runCases() {
        ...
        for (String[] fixture : fixtures) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> { student.removeRange(start, stop); return null; });
            Outcome oracleOutcome = Outcome.capture(() -> { oracle.removeRange(start, stop); return null; });
