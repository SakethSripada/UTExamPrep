...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> StudentSolution.getTeams(sWords, amount));
            Outcome oracleOutcome = Outcome.capture(() -> OracleStudentSolution.getTeams(oWords, amount));
