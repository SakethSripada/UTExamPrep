...
public class TestRunner {
    ...
    private static void runCases() {
        ...
        for (String[] fixture : fixtures) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> student.getRevCopyWithoutValue(target));
            Outcome oracleOutcome = Outcome.capture(() -> oracle.getRevCopyWithoutValue(target));
