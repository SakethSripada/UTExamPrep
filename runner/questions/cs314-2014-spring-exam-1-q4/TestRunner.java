...
public class TestRunner {
    ...
    private static void runCases() {
        ...
        for (int[][] fixture : fixtures) {
            ...
            SparseMatrix student = SparseMatrix.of(fixture);
            OracleSparseMatrix oracle = OracleSparseMatrix.of(fixture);
            SparseMatrix studentOther = SparseMatrix.of(otherFixture);
            OracleSparseMatrix oracleOther = OracleSparseMatrix.of(otherFixture);
            SparseMatrix sOther = studentOther;
            OracleSparseMatrix oOther = oracleOther;
            ...
            Outcome studentOutcome = Outcome.capture(() -> student.getFocusColor());
            Outcome oracleOutcome = Outcome.capture(() -> oracle.getFocusColor());
