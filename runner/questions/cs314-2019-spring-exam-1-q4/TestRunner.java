...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> student.getSemanticDescriptor(sScanner, "B"));
            Outcome oracleOutcome = Outcome.capture(() -> oracle.getSemanticDescriptor(oScanner, "B"));
