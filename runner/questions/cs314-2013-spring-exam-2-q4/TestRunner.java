...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Queue314 sQueue = new Queue314(); sQueue.addAll(Arrays.asList("A", "B", "A", "C", "A"));
            ...
            Outcome studentOutcome = Outcome.capture(() -> student.getAveDistanceFromFront(sQueue, target));
            Outcome oracleOutcome = Outcome.capture(() -> oracle.getAveDistanceFromFront(oQueue, target));
