...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Outcome studentOutcome = Outcome.capture(() -> student.examCall(sArray, amount, amount));
            Outcome oracleOutcome = Outcome.capture(() -> oracle.examCall(oArray, amount, amount));
