...
public class TestRunner {
    ...
    private static void runCases() {
        for (int caseIndex = 0; caseIndex < 6; caseIndex++) {
            ...
            Map sMap = new LinkedHashMap() {{ put("Book1", new ArrayList<>(Arrays.asList("Ada"))); put("Book2", new ArrayList<>(Arrays.asList("Bea", "Ada"))); }};
            ...
            Outcome studentOutcome = Outcome.capture(() -> StudentSolution.updateAuthors(sMap, sWords));
            Outcome oracleOutcome = Outcome.capture(() -> OracleStudentSolution.updateAuthors(oMap, oWords));
